# Data Model: UI/UX Redesign for Book Application

## Theme Configuration Entity

**Entity Name**: Theme Configuration
**Description**: Represents the current visual theme applied to the application interface

**Attributes**:
- **themeId**: String (unique identifier for the theme - "light" or "dark")
- **primaryColor**: HexColor (main brand color for the theme)
...
**Description**: Global styling parameters that define the visual design system
