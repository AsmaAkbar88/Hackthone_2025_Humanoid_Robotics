...
class DropFolderHandler(FileSystemEventHandler):
    ...
    def create_metadata(self, source: Path, dest: Path):
        ...
        For .md files, also includes the original content.
        ...
        # For .md files, read and include original content
        original_content = ""
        if file_type == 'md':
            try:
        ...
        if original_content:
            # Include original content for .md files
            content = f'''---
type: file_drop
...
'''
            ...
            # Generic template for non-md files
            content = f'''---
type: file_drop
original_name: {source.name}
file_type: {file_type}
