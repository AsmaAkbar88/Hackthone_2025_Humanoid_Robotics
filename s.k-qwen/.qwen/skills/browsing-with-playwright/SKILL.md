...
# Or manually
start /B npx @playwright/mcp@latest --port 8808 --shared-browser-context
```
...
On Windows:
```bash
# Using helper script (closes browser first - recommended)
stop-server.bat

# Or manually
python mcp-client.py call -u http://localhost:8808 -t browser_close -p '{}'
